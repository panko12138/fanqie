...
from themes import ThemeManager, ThemeType, Radius
from backup import BackupManager
from ui.components import (
    StyledButton, PrimaryButton, DangerButton, GhostButton,
    StyledComboBox, StyledCard, StyledSpinBox, Divider
)
...
class SettingsDialog(QDialog):
    ...
    def _create_timer_tab(self) -> QWidget:
        ...
        self.long_break_spin = StyledSpinBox()
        ...
        self.daily_goal_spin = StyledSpinBox()
    ...
    def _create_backup_tab(self) -> QWidget:
        ...
        backup_label.setStyleSheet(
            f"color: {self.theme_manager.get_colors()['text_primary']}; font-size: 14px; font-weight: 500; border: none;"
        )
        ...
        self.backup_list.setStyleSheet(f"""
            QListWidget {{
                background-color: {self.theme_manager.get_colors()['surface']};
                color: {self.theme_manager.get_colors()['text_primary']};
            ...
            QListWidget::item:selected {{
                background-color: {self.theme_manager.get_colors()['primary']};
                color: white;
            }}
        """)
